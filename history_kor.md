...
$$ K = 0.0025 \times 2^{19} = 0.0025 \times 524288 = 1310.72 $$

이 값을 반올림하면 **$K = 1311$**이 됩니다.
따라서 우리는 하드웨어에서 다음과 같이 연산합니다:

$$ \text{Result} = (\text{Input} \times 1311) \gg 19 $$

이때 실제 곱해지는 값은 $1311 / 2^{19} \approx 0.00250053$ 이며, 원래 목표인 $0.0025$와의 오차는 **약 0.02%**에 불과합니다. 이것이 바로 고정 소수점 연산의 마법입니다.
